...
export default function CartModal({ isOpen, onClose }: CartModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-20" onClick={onClose}>
            ...
            <div className="w-full max-w-[1110px] mx-auto relative h-full pointer-events-none">
                <div
                    className={`absolute top-28.5 left-1/2 transform -translate-x-1/2 bg-white px-7 py-8 rounded-lg shadow-xl w-[calc(100%_-_3rem)] pointer-events-auto
                md:w-[377px] md:left-auto md:right-10 md:translate-x-0 lg:right-0 transition-all duration-300 
                ${isAnimating
